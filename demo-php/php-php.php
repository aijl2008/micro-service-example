...
$tracing = (new \Artron\Zipkin('http://zipkin:9411'))->tracing('php-php-root', '127.0.0.1');
...
$client = new Client([
    'base_uri' => 'http://artsoapi1.artron.net',
    'timeout' => 10.0,
]);
$response = $client->request('GET', '/micro/aqlapi4http.php', [
    'headers' => $headers
]);
